...
(assert (fp.lt (fp.add RNE (fp.add RNE (fp.rem x0 x1) (fp.max x0 x3)) (fp.max (fp.rem x1 x3) (fp.min x0 x1))) (fp.fma RNE (fp.min (fp.roundToIntegral RNE x1) (fp.roundToIntegral RNE x3)) (fp.add RNE (fp.sqrt RNE x0) (fp.mul RNE x1 x2)) (fp.abs (fp.roundToIntegral RNE x2)))))(assert (fp.lt x0 pone ))
