...
(assert (fp.geq (fp.sub RNE (fp.abs (fp.min x2 x1)) (fp.max (fp.sqrt RNE x0) (fp.roundToIntegral RNE x3))) (fp.add RNE (fp.div RNE (fp.abs x1) (fp.abs x1)) (fp.add RNE (fp.mul RNE x1 x2) (fp.abs x2)))))(assert (fp.lt x0 pone ))
