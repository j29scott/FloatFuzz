...
(assert (fp.lt (fp.add RNE (fp.max (fp.rem x0 x1) (fp.max x0 x3)) (fp.roundToIntegral RNE (fp.rem x3 x3))) (fp.fma RNE (fp.min (fp.min x1 x3) (fp.roundToIntegral RNE x3)) (fp.add RNE (fp.sqrt RNE x0) (fp.mul RNE x1 x2)) (fp.abs (fp.min x2 (fp.mul RNE x2 x0))))))(assert (fp.lt x0 pone ))
