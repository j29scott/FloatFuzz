...
(assert (fp.eq (fp.add RNE (fp.div RNE (fp.add RNE x1 x3) (fp.add RNE x3 x1)) (fp.add RNE (fp.mul RNE x0 x2) (fp.sub RNE x3 x1))) (fp.div RNE (fp.div RNE (fp.div RNE x3 x0) (fp.neg x3)) (fp.sub RNE (fp.neg x3) (fp.add RNE x3 x2)))))(assert (fp.lt x0 pone ))
