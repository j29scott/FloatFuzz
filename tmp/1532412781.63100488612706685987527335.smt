...
(assert (fp.isPositive (fp.sub RNE (fp.mul RNE (fp.div RNE x1 x0) (fp.add RNE x0 x0)) (fp.add RNE (fp.add RNE x0 x1) (fp.roundToIntegral RNE x0)))))(assert (fp.lt x0 pone ))
