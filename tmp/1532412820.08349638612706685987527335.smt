...
(assert (fp.lt (fp.sub RNE (fp.abs (fp.min x2 x1)) (fp.max (fp.sqrt RNE x0) (fp.roundToIntegral RNE x3))) (fp.sqrt RNE (fp.div RNE (fp.neg x2) (fp.rem x0 x1)))))(assert (fp.lt x0 pone ))
