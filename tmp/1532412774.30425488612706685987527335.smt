...
(assert (fp.isPositive (fp.fma RNE (fp.mul RNE (fp.div RNE x1 x0) (fp.add RNE x0 x0)) (fp.add RNE (fp.add RNE x3 x0) (fp.roundToIntegral RNE x0)) (fp.rem (fp.roundToIntegral RNE (fp.mul RNE x3 x2)) (fp.sub RNE (fp.div RNE x3 x0) (fp.sqrt RNE x1))))))(assert (fp.lt x0 pone ))
