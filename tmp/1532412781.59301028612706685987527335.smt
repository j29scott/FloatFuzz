...
(assert (fp.isPositive (fp.sub RNE (fp.fma RNE (fp.div RNE x1 x0) (fp.add RNE x0 x0) (fp.rem (fp.sqrt RNE x0) (fp.min x0 x2))) (fp.add RNE (fp.add RNE x0 x0) (fp.roundToIntegral RNE x0)))))(assert (fp.lt x0 pone ))
