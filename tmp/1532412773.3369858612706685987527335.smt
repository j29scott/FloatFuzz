...
(assert (fp.gt (fp.abs (fp.fma RNE (fp.add RNE x1 x3) (fp.mul RNE x1 x1) (fp.sqrt RNE x1))) (fp.sqrt RNE (fp.div RNE (fp.sqrt RNE x2) (fp.rem x3 x0)))))(assert (fp.lt x0 pone ))
