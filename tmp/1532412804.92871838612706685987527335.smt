...
(assert (fp.isPositive (fp.sub RNE (fp.mul RNE (fp.div RNE x3 x0) (fp.fma RNE x0 (fp.mul RNE x1 x3) (fp.fma RNE x2 x2 x2))) (fp.add RNE (fp.add RNE x0 x0) (fp.roundToIntegral RNE x0)))))(assert (fp.lt x0 pone ))
