...
(assert (fp.gt (fp.sub RNE (fp.mul RNE (fp.div RNE x3 x0) (fp.sqrt RNE x0)) (fp.div RNE (fp.add RNE x0 x0) (fp.roundToIntegral RNE x0))) (fp.sub RNE (fp.neg (fp.add RNE x1 x2)) (fp.min (fp.add RNE x0 x2) (fp.fma RNE x3 x3 x1)))))(assert (fp.lt x0 pone ))
