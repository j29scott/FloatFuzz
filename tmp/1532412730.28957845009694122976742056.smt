...
(assert (fp.geq (fp.add RNE (fp.neg (fp.add RNE x2 x2)) (fp.neg (fp.neg x1))) (fp.add RNE (fp.sub RNE (fp.div RNE x2 (fp.div RNE x2 x2)) (fp.mul RNE x0 x1)) (fp.add RNE (fp.mul RNE x3 x2) (fp.neg x1)))))(assert (fp.lt x0 pone ))
