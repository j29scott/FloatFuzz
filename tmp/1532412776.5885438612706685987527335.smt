...
(assert (fp.isPositive (fp.sub RNE (fp.fma RNE (fp.div RNE x1 x0) (fp.add RNE x0 x0) (fp.neg (fp.sqrt RNE x0))) (fp.add RNE (fp.add RNE x3 x0) (fp.roundToIntegral RNE x0)))))(assert (fp.lt x0 pone ))
