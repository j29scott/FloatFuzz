...
(assert (fp.eq (fp.div RNE (fp.min (fp.neg x2) (fp.roundToIntegral RNE x2)) (fp.sub RNE (fp.sub RNE x0 x0) (fp.rem x0 x1))) (fp.max (fp.rem (fp.sub RNE x1 x2) (fp.fma RNE x1 x3 x3)) (fp.mul RNE (fp.min x1 x0) (fp.rem (fp.fma RNE x0 x0 x1) (fp.rem x0 x2))))))(assert (fp.lt x0 pone ))
