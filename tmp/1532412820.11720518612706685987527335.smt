...
(assert (fp.geq (fp.sub RNE (fp.abs (fp.min x2 x1)) (fp.max (fp.sqrt RNE x0) (fp.roundToIntegral RNE x3))) (fp.abs (fp.mul RNE (fp.rem x3 x1) (fp.rem x0 x3)))))(assert (fp.lt x0 pone ))
