...
(assert (fp.gt (fp.abs (fp.fma RNE (fp.add RNE x1 x0) (fp.mul RNE x1 x1) (fp.sqrt RNE x1))) (fp.sqrt RNE (fp.div RNE (fp.fma RNE x2 x3 x2) (fp.rem x3 x0)))))(assert (fp.lt x0 pone ))
