...
(assert (fp.lt (fp.add RNE (fp.abs (fp.min x2 x1)) (fp.max (fp.sqrt RNE x0) (fp.roundToIntegral RNE x3))) (fp.sqrt RNE (fp.div RNE (fp.sub RNE x1 x2) (fp.rem x2 x2)))))(assert (fp.lt x0 pone ))
