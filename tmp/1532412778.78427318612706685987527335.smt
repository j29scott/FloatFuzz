...
(assert (fp.isPositive (fp.sub RNE (fp.mul RNE (fp.div RNE x1 x0) (fp.add RNE x0 x0)) (fp.add RNE (fp.fma RNE x3 x0 (fp.rem x3 x2)) (fp.roundToIntegral RNE x0)))))(assert (fp.lt x0 pone ))
