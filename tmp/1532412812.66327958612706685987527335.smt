...
(assert (fp.lt (fp.add RNE (fp.max (fp.rem x0 x1) (fp.max x0 x3)) (fp.roundToIntegral RNE (fp.rem x3 x3))) (fp.sqrt RNE (fp.min (fp.min x1 x3) (fp.roundToIntegral RNE x3)))))(assert (fp.lt x0 pone ))
